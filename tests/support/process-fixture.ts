...
export function processFixture(mode: 'seed' | 'seed-repair' | 'restore-repair-crash' | 'restore-repair' | 'seed-dag' | 'seed-paused' | 'restore' | 'restore-execution' | 'restore-worker-crash' | 'restore-worker-recovery' | 'restore-acceptance-crash' | 'restore-promotion-crash' | 'restore-stale-target' | 'restore-ambiguous-promotion' | 'restore-acceptance' | 'restore-dag' | 'worker' | 'worker-restore' | 'contender' | 'integration-owner', directory: string) {
