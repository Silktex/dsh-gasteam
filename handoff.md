...
Published `928d72803e2931d5c87707ba2955e8ad9f3dbba7` passed [exact-commit CI](https://github.com/Silktex/dsh-gasteam/actions/runs/34001873807). It renders reported dashboard usage and fixes the mailbox test timing failure from e010650. M0–M5 and M7 are complete; M6, M8–M11 and final acceptance remain unfinished. Agents are correcting reviewed M6 handoff and M10 batching gaps, and validating M8 against a disposable service. Read the latest evidence, including the demo setup profile incident and narrow link correction.
