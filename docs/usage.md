...
These operations are available through the typed Remote/RPC surface, but the current Web panel has no workspace dashboard or batch controls. The broader M8 dashboard remains pending.
