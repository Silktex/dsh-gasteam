...
- Changed files and commit: published through4b1279f; next reviewed checkpoint includes M3 provisioning state/DSH/coordinator, tests and docs. Preserve unrelated docs/README.md, darkfactory.md, docs/worklist.md and pending.md.
...
- Next concrete action: publish and verify M3 completion checkpoint; integrate validated shared-provider capability foundation, then implement bounded checkpointed handoff/fenced replacement. Continue remaining M6/M8/M9, M10/M11 and every final acceptance requirement.
