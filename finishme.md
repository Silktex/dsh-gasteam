...
- Next concrete action: publish the validated code-workflow checkpoint, finish external-runtime foundation regression/publication, then implement authorized publication runtime and provider admission/coordinator wiring. Continue remaining M1–M11 and final acceptance requirements; no milestone is complete merely because this slice passes.
