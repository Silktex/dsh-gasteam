...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  TeamWorktreeSpec: 'agent-team.md',
  TeamWorktreeSnapshot: 'agent-team.md',
  TeamWorktreeProvider: 'agent-team.md',
  TeamIntegrationId: 'agent-team.md',
  TeamVerificationCommand: 'agent-team.md',
  TeamIntegrationSpec: 'agent-team.md',
  TeamIntegrationSnapshot: 'agent-team.md',
  TeamIntegrationProvider: 'agent-team.md',
  TeamRecoverySnapshot: 'agent-team.md',
  RecoverTeammateRequest: 'agent-team.md',
  TeamBatchId: 'agent-team.md',
  TeamBatchSnapshot: 'agent-team.md',
  TeamBatchView: 'agent-team.md',
  CreateTeamBatchRequest: 'agent-team.md',
  UpdateTeamBatchRequest: 'agent-team.md',
